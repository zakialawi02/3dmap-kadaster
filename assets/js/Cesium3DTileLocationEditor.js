...
window.Cesium3dTilesetLocationEditor = (function () {
  ...
  _.prototype._onScreeSpaceLeftDown = function (movement) {
    ...
    const pick = this._cesiumViewer.scene.pick(movement.position);
  ...
  */
  ...
  _.prototype._createAxesEntities = function () {
    ...
    this._xAxisEntity = this._cesiumViewer.entities.add({
    ...
    this._yAxisEntity = this._cesiumViewer.entities.add({
    ...
    this._zAxisEntity = this._cesiumViewer.entities.add({
