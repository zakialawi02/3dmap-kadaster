...
-- Dumping data for table rrrcadastre2.linked_uri: ~371 rows (approximately)
...
-- Dumping data for table rrrcadastre2.renters_tenants: ~103 rows (approximately)
INSERT INTO `renters_tenants` (`id`, `tenant_id`, `room_id`, `due_started`, `due_finished`, `tenure_status`, `agreement_number`, `permit_flats`) VALUES
	...
	(16, 16, '0169', NULL, NULL, 'lease', '0016/1679/3573403/2024', NULL),
	...
	(23, 23, '0178', NULL, NULL, 'Sewa', '0023/1679/3573403/2024', 'S_0023.1679.3573403.2024.pdf'),
	...
	(36, 36, '0129', NULL, NULL, 'lease', '0036/1679/3573403/2024', NULL),
	...
	(85, 85, '0131', NULL, NULL, 'lease', '0085/1679/3573403/2024', NULL),
	(86, 86, '0141', NULL, NULL, 'lease', NULL, NULL),
	(87, 87, '0132', NULL, NULL, 'lease', NULL, NULL),
	(88, 88, '0133', NULL, NULL, 'lease', '0088/1679/3573403/2024', NULL),
	(89, 89, '0134', NULL, NULL, 'lease', NULL, NULL),
	(90, 90, '0135', NULL, NULL, 'lease', '0090/1679/3573403/2024', NULL),
	(91, 91, '0136', NULL, NULL, 'lease', NULL, NULL),
	(92, 92, '0137', NULL, NULL, 'lease', NULL, NULL),
	(93, 93, '0138', NULL, NULL, 'lease', '0093/1679/3573403/2024', NULL),
	...
	(124, 124, '0031', '2024-08-01', '2099-07-31', 'Pakai', '0124/1679/3578071/2024', 'S_0124.1679.3578071.2024.pdf');
...
INSERT INTO `rooms_table` (`room_id`, `legal_object_id`, `organizer_id`, `room_name`, `space_usage`, `rent_fee`, `uri_room`, `is_public`) VALUES
	...
	('0027', 817240, 2, 'Kriya Gallery', 'Pertokoan', '', 'https://direktori.vokasi.unair.ac.id/2023/07/24/surabaya-kriya-gallery-siola/15561/pusat-oleh-oleh-khas-surabaya/vokasi/', 0),
	('0028', 820143, 2, 'Museum', 'Perkantoran', '', 'https://tiketwisata.surabaya.go.id/destination/museum-surabayagedung-siola', 0),
	('0029', 820815, 2, 'Tangga', 'Benda Bersama', '', NULL, 1),
	('0030', 820896, 2, 'Toliet Umum', 'Benda Bersama', '', '', 1),
	('0031', 821077, 2, 'UPTSA (Unit Pelayanan Terpadu Satu Atap)', 'Perkantoran', '', 'https://maps.app.goo.gl/iGeY4sK3VMYMei3q8', 0),
...
-- Dumping data for table rrrcadastre2.tenants_table: ~103 rows (approximately)
INSERT INTO `tenants_table` (`id`, `tenant_name`, `name_number`, `tenant_job`, `tenant_religion`, `marriage_status`, `number_residents`, `tenant_address`, `tenant_rt_rw`, `tenant_village`, `tenant_district`, `tenant_city`, `tenant_province`) VALUES
	...
	(124, 'Kepala Unit', '357809 000000001', 'ASN', 'Islam', NULL, NULL, 'Jalan Genteng Kali No. 117, Alon-Alon Contong', '{"tenant_rt":"00","tenant_rw":"00"}', 'Bubutan', 'Genteng', 'Surabaya', 'Jawa Timur');
...
-- Dumping data for table rrrcadastre2.users: ~3 rows (approximately)
