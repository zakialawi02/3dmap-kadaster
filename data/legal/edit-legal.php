...
<head>
    ...
    <title>Edit legal parcel data</title>
</head>
...
<body>
    ...
    <main>
        ...
        <div class="container ">
            <div class="row justify-content-center  m-2 py-3">
                ...
                <?php endif ?>
                <form action="/action/save-legal-object.php?parcel=<?= $legal_objects_table['id']; ?>" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="parcel_name" name="parcel_name" autocomplete="off" value="<?= old('parcel_name') ?? $legal_objects_table['parcel_name']; ?>">
                    </div>
                    <div class="mb-3">
    ...
    <script>
        getLandParcel2Select(<?= json_encode($legal_objects_table['parcel_id']) ?>);
