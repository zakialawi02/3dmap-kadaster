    ...
    <main>
        <div class="container ">
            <div class="row justify-content-center  m-2 p-3">
                ...
                <?php endif ?>
                <form action="/action/save-management.php" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="organizer_name" class="form-label">Organizer Name</label>
                        <input type="text" class="form-control" id="organizer_name" name="organizer_name" value="<?= old('organizer_name'); ?>" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="organizer_head" name="organizer_head" value="<?= old('organizer_head'); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="organizer_address" class="form-label">Organizer Address</label>
                        <input type="text" class="form-control" id="organizer_address" name="organizer_address" value="<?= old('organizer_address'); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="organizer_city" class="form-label">Organizer City</label>
                        <input type="text" class="form-control" id="organizer_city" name="organizer_city" value="<?= old('organizer_city'); ?>" required>
                    </div>
